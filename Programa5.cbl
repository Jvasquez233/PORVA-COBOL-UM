      ...
      * Date:    16-04-2019
      * Purpose: IMPRIMIR VENDEDORES DESCENDENTES POR CODIGO DE VENDEDOR
      * Tectonics: cobc
      ******************************************************************
      ...
      -    "iles\venddecs.txt"
           ...
           SELECT INFORME5 ASSIGN "C:\Users\Jose Angel\Documents\cobol\f
      -    "iles\informe5.txt"
      ...
      *
       ...
       01  AREA-DE-TRABALHO.
           ...
           05 CONSTANT-LITERALES.
              10 LT-PROGRAMA               PIC X(009)  VALUE "PROGRAMA5"
              .
      ...
      -    " DE VENDEDORES DESCENDENTES POR CODIGO DE VENDEDOR".
      ...
      -    "O:".
       ...
       IMPRIMIR-CAB.
           ...
           WRITE REG-INFORME5 FROM NOME-PROGRAMA
           AFTER ADVANCING 1 LINES
           WRITE REG-INFORME5 FROM DATE-PROGRAMA
           AFTER ADVANCING 1 LINES
           WRITE REG-INFORME5 FROM HORA-PROGRAMA
           AFTER ADVANCING 1 LINES
           WRITE REG-INFORME5 FROM LINEA-ENCAB-VEN
           AFTER ADVANCING 1 LINES
           WRITE REG-INFORME5 FROM LINEA-BLNKS
           AFTER ADVANCING 1 LINES.
       ...
       IMPRIMIR-DET.
           ...
           WRITE REG-INFORME5 FROM DETALLE-VEN
           AFTER ADVANCING 1 LINES.
